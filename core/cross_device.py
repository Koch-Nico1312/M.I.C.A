...
class CrossDeviceHandover:
    ...
    def sync_send_task_completion(self, task: str, result: str,
                                  platform: str = "both") -> bool:
        ...
        try:
            return loop.run_until_complete(
                self.send_task_completion(task, result, platform)
            )
        finally:
            loop.close()

    def sync_send_file(self, file_path: str, caption: str = "",
                       platform: str = "both") -> bool:
