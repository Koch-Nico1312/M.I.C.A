...
class PluginManager:
        ...
        try:
            ...
            if hasattr(module, 'TOOL_DECLARATION'):
                ...
                if hasattr(module, handler_name):
                    ...
                    print(f"[Plugin] WARN: Handler '{handler_name}' not found in {plugin_path.name}")
    ...
    def create_plugin_template(self, name: str, description: str, parameters: Dict[str, Any]) -> Path:
