...
class InputValidator:
    ...
    @classmethod
    def validate_text(cls, text: str, max_length: Optional[int] = None) -> tuple[bool, Optional[str]]:
        """
    ...
    @classmethod
    def validate_file_path(cls, path: str, allowed_base_dirs: Optional[List[Path]] = None) -> tuple[bool, Optional[str]]:
        """
        ...
        if allowed_base_dirs:
            is_allowed = any(
                str(abs_path).startswith(str(base_dir.resolve()))
    ...
    @classmethod
    def validate_command(cls, command: str, allowed_commands: Optional[List[str]] = None) -> tuple[bool, Optional[str]]:
        """
...
class CodeSandbox:
    ...
    DANGEROUS_FUNCTIONS = {
        ...
        'reload', 'exit', 'quit', 'input', 'raw_input'
    }
...
class SecureFileOperations:
    ...
    def __init__(self, allowed_base_dirs: Optional[List[Path]] = None):
        ...
        logger.info(f"Secure file operations initialized with {len(self.allowed_base_dirs)} allowed directories")
