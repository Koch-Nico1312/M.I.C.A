...
class OllamaFallback:
    ...
    def _start_ollama_server(self) -> None:
        ...
        try:
            ...
            print("[Ollama] ❌ Ollama executable not found. Please install Ollama from https://ollama.com")
        except Exception as e:
    ...
    def generate_tool_call(self, prompt: str, available_tools: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
