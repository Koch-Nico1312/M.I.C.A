...
class HUDOverlay(QWidget):
    ...
    def add_highlight(self, x: int, y: int, width: int = 50, height: int = 50, 
                     color: str = None, duration: float = 2.0) -> str:
    ...
    def update_animation(self):
        ...
        expired = [
            hid for hid, hl in self.highlights.items()
        ...
        self.mouse_trail = [
            (x, y, t) for x, y, t in self.mouse_trail
