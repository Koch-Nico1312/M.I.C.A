...
class RobloxController:
    ...
    def _extract_metrics(self, screen) -> GameMetrics:
        ...
        try:
            ...
            self._log(f"OCR extracted - Health: {metrics.health}, Score: {metrics.score}, Coins: {metrics.coins}")
    ...
    def start_playing(self, strategy: str = "balanced", goal: Optional[Dict] = None, game_type: str = "generic"):
        ...
        self._log(f"Started Roblox gameplay - Type: {self.game_type.value}, Strategy: {strategy}, {goal_desc}")
