...
class DreamMemory:
    ...
    def _init_db(self) -> None:
        ...
        with _lock:
            ...
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_rel_concept_a ON relationships(concept_a)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_rel_concept_b ON relationships(concept_b)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_fact_source ON facts(source_conversation_id)")
