...
import { Send, Sparkles, ChevronUp, BrainCircuit, Paperclip, Code, Image as ImageIcon } from "lucide-react";
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const aiMessage: Message = {
        ...
        role: "assistant",
        content: `Ich habe Ihre Nachricht erhalten (Modus: ${selectedMode}) und verarbeite sie...`,
      };
          ...
          <div className="relative flex-1" ref={optionsRef}>
            ...
            <div className="relative bg-white/40 backdrop-blur-md rounded-2xl border border-white/40 flex items-end">
              ...
              <Textarea
                ...
                placeholder={`Nachricht schreiben (${selectedMode})...`}
